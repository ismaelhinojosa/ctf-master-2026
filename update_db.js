...
const newDBStr = JSON.stringify(encryptedDB, null, 4);
const newDBRegex = /this\.encryptedDB = \{[\s\S]*?\n        \};/;

let js = fs.readFileSync('script.js', 'utf8');
js = js.replace(newDBRegex, 'this.encryptedDB = ' + newDBStr + ';');
fs.writeFileSync('script.js', js);
console.log('Database updated in script.js');
